    ...
    >
      <div className="flex-1 text-center md:text-left">
        ...
        <p className="text-sm leading-6 text-darkBlue mb-6 md:w-4/5">
          Turning dreams into homes. Explore our exacptional craftsmanship and
          envision you prefect space.
        </p>
      ...
      <div className="flex gap-2 justify-center md:gap-3 lg:gap-5">
        <img
          className="hero-img"
          src="/assets/example/one/house1.png"
          alt="img one"
        />
        <img
          className="hero-img mt-[5%]"
          src="/assets/example/one/house2.png"
          alt="img two"
        />
        <img
          className="hero-img"
          src="/assets/example/one/house3.png"
          alt="img three"
        />
      </div>
    </section>
